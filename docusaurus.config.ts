...
const config: Config = {
  ...
  tagline: 'Learn Languages with Games',
  ...
  url: 'https://docs.gamesentenceminer.com',
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl:
            'https://github.com/bpwhelan/gsm-docs',
        },
        blog: {
      ...
      links: [
        ...
        },
        {
          ...
          items: [
            ...
            {
              label: 'YouTube',
              href: 'https://www.youtube.com/@GameSentenceMiner',
            },
          ],
        },
      ],
      copyright: `Copyright © ${new Date().getFullYear()} Beangate, Built with Docusaurus.`,
    },
    prism: {
